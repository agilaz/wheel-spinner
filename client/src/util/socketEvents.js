...
export const REQUEST_SPIN = 'user-request-spin';
export const REQUEST_ROTATION_SYNC = 'user-request-rotation';
export const REQUEST_SPINNABLE = 'user-request-spinnable';